<style>
    ...
    .donate_button{
        ...
        width: 142px;
        border: 0;
        background: url('templates/tibiacom/images/global/buttons/button_red.png');
        font-family: Verdana;
        font-weight: 100;
        color: #f1c232;
        font-size: 12px;
    ...
    .donate_button:hover{
        background: url('templates/tibiacom/images/global/buttons/button_red_hover.png');
        color: #fff;
    }
</style>
<div class="donate">
    ...
    <div class="donate_content">
        ...
        <a href="<?php echo BASE_URL ?>?subtopic=buypoints">
